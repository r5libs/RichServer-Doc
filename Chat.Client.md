...
UpdateTaskMemberDataMessage:
  ...
  string[] MemberDataList;
    揪運動:
      101: [0]: GPS位置(若不公開,請填""), [1]: 玩家個人步數(此次新增)
      102: [0]: GPS位置(若不公開,請填""), [1]: 玩家個人里程(此次新增)
    揪一起:
      201: [0]: 已確認報到(0 or 1), [1]: 已確認開始(0 or 1), [2]: 玩家個人聊天句數(此次新增)
```
...
TaskMemberData:
  ...
  string[] MemberDataList;
    ...
    揪一起:
      201: [0]: 已確認報到(0 or 1), [1]: 已確認開始(0 or 1), [2]: 玩家個人聊天總句數
```
